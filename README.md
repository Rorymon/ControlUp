...
Above you can see an example of the morning report using the default the configuration.
...
In the above example, you can see some of the colour coding I have included to highlight when VMTools are out of date and to show which machines rebooted the day the report was run.
...
If you would like to change what metrics the report displays, you can do this. Find the metrics you would like to use in one of the Export Schedule reports.
